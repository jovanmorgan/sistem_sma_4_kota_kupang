...
<body>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-warning btn-sm"
                                                                            onclick="openEditModal('<?php echo $row['id_pegawai']; ?>','<?php echo $row['nip']; ?>','<?php echo $row['nama']; ?>','<?php echo $row['jk']; ?>','<?php echo $row['agama']; ?>','<?php echo $row['tempat_lahir']; ?>','<?php echo $row['tanggal_lahir']; ?>','<?php echo $row['alamat']; ?>','<?php echo $row['jabatan']; ?>')">Edit</button>
    ...
    <script>
        function openEditModal(id, nip, nama, jk, agama, tempat_lahir, tanggal_lahir, alamat, jabatan) {
