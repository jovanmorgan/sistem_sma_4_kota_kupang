                     ...
                     <div class="card-body text-center">
                         ...
                         <form method="GET" action="">
                             <div class="input-group mt-3">
                                 <input type="text" class="form-control" placeholder="Cari profile_sekolah ..."
                                     name="search"
                                     ...
                                     <tbody>
                                         <?php
                                            ...
                                            ?>
                                             ...
                                             <!-- Modal Edit Dinamis -->
                                             <div class="modal fade" id="editModal-<?php echo $id_profile_sekolah; ?>"
                                                 tabindex="-1"
                                                 ...
                                                 <div class="modal-dialog">
                                                     <div class="modal-content">
                                                         <div class="modal-header">
                                                             ...
                                                             <button id="closeEditModal" type="button" class="btn-close"
                                                                 data-bs-dismiss="modal" aria-label="Close"></button>
                                                         </div>
                                                         <div class="modal-body">
                                                             <form id="editForm-<?php echo $id_profile_sekolah; ?>"
                                                                 method="POST"
                                                                 action="proses/<?= $page_title_proses ?>/edit.php"
                                                                 enctype="multipart/form-data">
                                                                 <input type="hidden" name="id_profile_sekolah"
                                                                 ...
                                                                 <!-- Textarea VISI -->
                                                                 <div class="mb-3">
                                                                     <label for="visi-<?php echo $id_profile_sekolah; ?>"
                                                                         class="form-label">VISI</label>
                                                                     <textarea id="visi-<?php echo $id_profile_sekolah; ?>"
                                                                         name="visi" class="form-control" rows="3"
                                                                         required><?php echo $visi; ?></textarea>
                                                                 </div>

                                                                 <!-- Textarea MISI -->
                                                                 <div class="mb-3">
                                                                     <label for="misi-<?php echo $id_profile_sekolah; ?>"
                                                                         class="form-label">MISI</label>
                                                                     <textarea id="misi-<?php echo $id_profile_sekolah; ?>"
                                                                         name="misi" class="form-control" rows="3"
                                                                         required><?php echo $misi; ?></textarea>
                                                                 </div>

                                                                 <!-- Textarea ALAMAT SEKOLAH -->
                                                                 <div class="mb-3">
                                                                     <label for="alamat-<?php echo $id_profile_sekolah; ?>"
                                                                         class="form-label">Alamat
                                                                         Sekolah</label>
                                                                     <textarea id="alamat-<?php echo $id_profile_sekolah; ?>"
                                                                         name="alamat_sekolah" class="form-control" rows="3"
