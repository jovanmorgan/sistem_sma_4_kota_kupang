...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0) {
        ...
        if (in_array($file_ext, $allowed_extensions)) {
            ...
            $upload_dir = '../../../../assets/img/galery/'; // Tentukan direktori untuk menyimpan gambar
            $upload_path = $upload_dir . $new_file_name;

            // Memindahkan file yang diunggah ke direktori yang telah ditentukan
            if (move_uploaded_file($file_tmp, $upload_path)) {
                // Menyimpan data ke database
                $query = "INSERT INTO galery (nama, waktu, deskripsi, gambar) VALUES ('$nama', '$waktu', '$deskripsi', '$new_file_name')";
