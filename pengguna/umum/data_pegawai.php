...
<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px">
        <div class="container text-center my-5 py-5">
            <h1 class="text-white mt-4 mb-4">Silakan Lihat Dan Cari Data Pegawai Disini</h1>
            <h1 class="text-white display-1 mb-5">DATA PEGAWAI</h1>
                ...
                <form method="GET" action="">
                    <div class="input-group">
                        <input type="text" name="search"
                            ...
                            placeholder="Masukkan Nama Atau Nip Pegawai Disini" required />
                                                    ...
                                                    <table class="table table-hover text-center mt-3"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo htmlspecialchars($row['id_pegawai']); ?>
                                                                </td>
