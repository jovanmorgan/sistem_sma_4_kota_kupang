...
<body>
                                            ...
                                            <form method="GET" action="">
                                                <div class="input-group mt-3">
                                                    <input type="text" class="form-control"
                                                        placeholder="Cari profile_sekolah ..."
                                                        name="search"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <input type="hidden" id="edit_id" name="id_profile_sekolah">

                                <!-- Nama profile_sekolah -->
                                <div class="mb-3">
                                    <label for="visi" class="form-label">VISI</label>
                                    <input type="text" id="visi" name="visi" class="form-control" required>
                                </div>
                                <!-- Nama profile_sekolah -->
                                <div class="mb-3">
                                    <label for="visi" class="form-label">MISI</label>
                                    <input type="text" id="misi" name="misi" class="form-control" required>
                                </div>
                                <!-- Nama profile_sekolah -->
                                <div class="mb-3">
                                    <label for="visi" class="form-label">ALAMAT SEKOLAH</label>
                                    <input type="text" id="alamat_sekolah" name="alamat_sekolah" class="form-control"
                                        required>
                                </div>
                                <div class="text-end">
    ...
    <script>
        function openEditModal(id, visi, misi, alamat_sekolah) {
            let editModal = new bootstrap.Modal(document.getElementById('editModal'));
            document.getElementById('edit_id').value = id;
            document.getElementById('visi').value = visi;
            document.getElementById('misi').value = misi;
            document.getElementById('alamat_sekolah').value = alamat_sekolah;
            editModal.show();
        }
    </script>
