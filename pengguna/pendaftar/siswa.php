...
<body>
    ...
    <script>
        function openEditModal(id, nis, siswa, jk, agama, tempatLahir, tanggalLahir, alamat, idKelas) {
            let editModal = new bootstrap.Modal(document.getElementById('editModal'));

            document.getElementById('edit_id').value = id;
            document.getElementById('edit_nis').value = nis;
            document.getElementById('edit_siswa').value = siswa;
            document.getElementById('edit_jk').value = jk; // Set value for jenis kelamin
            ...
            document.getElementById('edit_id_kelas').value = idKelas; // Set value for id_kelas
