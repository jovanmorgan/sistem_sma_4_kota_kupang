...
<body>
                                            ...
                                            <form method="GET" action="">
                                                <div class="input-group mt-3">
                                                    <input type="text" class="form-control"
                                                        placeholder="Cari kelas ..." name="search"
                            ...
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="id_jurusan" name="id_jurusan" class="form-select" required>
                                        ...
                                        <?php
                                        // Fetch jurusan for the dropdown
                                        $jurusan_query = "SELECT * FROM jurusan";
                                        $jurusan_result = $koneksi->query($jurusan_query);
                                        while ($jurusan = $jurusan_result->fetch_assoc()) {
                                            echo '<option value="' . $jurusan['id_jurusan'] . '">' . htmlspecialchars($jurusan['nama_jurusan']) . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" id="closeEditModal" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
    ...
    <script>
        function openEditModal(id_kelas, nama_kelas, id_jurusan, id_guru) {
